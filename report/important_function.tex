...
ShadCN UI components. They are used throughout the frontend. We also modified
these components in order to match our desired functionalities, including the data tables, which
we used in many of our pages. On top of this, we used tweakCN's Clean Slate theme and
shadcn.io's component for dark mode transition animation
