...
\begin{table}[h]
    ...
    \begin{tabular}{lp{9cm}}
        \hline
        \texttt{frontend/src/home/Home.jsx} & Landing page (hero + feature cards). \\
        \texttt{frontend/src/location/LocationList.jsx} & Locations directory page. \\
        \texttt{frontend/src/location/LocationListTable.jsx} & Reusable table, filters, distance column, admin actions. \\
        \texttt{frontend/src/location/CreateLocationSheet.jsx} & Admin create side sheet with map preview. \\
        \texttt{frontend/src/location/EditLocationSheet.jsx} & Admin edit side sheet with map preview. \\
        \texttt{frontend/src/event/EventList.jsx} & Event list with admin toolbar. \\
        \texttt{frontend/src/event/CreateNewEventSheet.jsx} & Admin create event sheet. \\
        \texttt{frontend/src/event/EditEventSheet.jsx} & Admin edit event sheet. \\
        \texttt{frontend/src/favourites/FavouriteList.jsx} & Favourites view (locations only). \\
        \texttt{frontend/src/lib/locations.api.js} & REST helpers for locations (GET/POST/PUT/DELETE). \\
        \texttt{frontend/src/event/event.api.js} & REST helpers for events (GET/POST/PUT/DELETE). \\
        \texttt{frontend/src/lib/favourites.js} & LocalStorage store for star toggles. \\
        \texttt{frontend/src/hooks/use-locations-with-distance.js} & Geolocation + haversine distance computation. \\
        \texttt{frontend/src/components/map-component.jsx} & Leaflet map, marker preview. \\
        \texttt{frontend/src/components/ui/data-table/*} & Table, column header, view options components. \\
        \hline
    \end{tabular}
\end{table}
